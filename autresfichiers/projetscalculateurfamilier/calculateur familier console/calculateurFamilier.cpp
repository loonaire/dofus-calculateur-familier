...
calculateurFamilier::calculateurFamilier(int bonusMax, int nbPointParPalier) : bonusMaxFamilier(bonusMax), nombrePointParPalier(nbPointParPalier){
}
...
void calculateurFamilier::addMonstre(std::string nom,int nbMonstreParPalier, int nbMonstreTuer, int nbMonstreParSalle[]){	
